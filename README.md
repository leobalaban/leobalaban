...
Coursework completed: Programação de Computadores, Engenharia de Prompt e Aplicações em IA, Prototipagem de Sistemas Computacionais, Interface e Jornada do Usuário.
Coursework in progress: Algoritmos e Pensamento Computacional, Modelagem de Banco de Dados, Desenvolvimento Front-end para Web, Design Profissional.
